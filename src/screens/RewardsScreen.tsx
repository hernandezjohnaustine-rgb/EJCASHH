  ...
  return (
    <div className="flex flex-col gap-8 h-full bg-brand-black p-6 pb-32 overflow-y-auto">
      <header className="flex flex-col gap-4">
        ...
        <GlassCard className="relative overflow-hidden bg-gradient-to-br from-brand-blue/20 to-brand-neon/20 border-brand-neon/20">
           <div className="flex flex-col gap-1 items-center justify-center py-4">
              ...
              <p className="text-xs text-brand-neon font-bold tracking-widest uppercase mt-4">2,450 / 5,000 pts to Platinum</p>
              ...
              <div className="w-full h-1.5 bg-white/5 rounded-full mt-4 overflow-hidden">
                 <motion.div 
                   ...
                   className="h-full bg-gradient-to-r from-brand-blue to-brand-neon shadow-[0_0_10px_#00F0FF]"
                 />
              </div>
           </div>
        </GlassCard>
      ...
      <section className="flex flex-col gap-6">
         ...
         <div className="flex gap-4 overflow-x-auto -mx-6 px-6 pb-2">
            <button className="glass-card min-w-[200px] !p-4 flex flex-col gap-4 hover:border-brand-neon/40 transition-colors">
               ...
               <div className="flex items-center justify-between pt-2 border-t border-white/5">
                  <span className="text-[10px] font-bold text-brand-neon">Progress 60%</span>
                  <div className="w-20 h-1 bg-white/5 rounded-full overflow-hidden">
                     <div className="h-full bg-brand-neon w-[60%]"></div>
                  </div>
               </div>
            </button>
            <button className="glass-card min-w-[200px] !p-4 flex flex-col gap-4 hover:border-brand-neon/40 transition-colors">
               ...
               >
                  <div className="flex items-center gap-4">
                     <div className="w-14 h-14 rounded-2xl bg-white/5 flex flex-col items-center justify-center border border-white/5">
                        ...
                        <PartyPopper className="w-6 h-6 text-brand-neon" />
                     </div>
                     <div>
                        <h4 className="text-sm font-bold">{reward.title}</h4>
                        <p className="text-xs text-white/60 font-medium">{reward.merchant}</p>
                        <p className="text-[10px] text-brand-neon font-black uppercase tracking-widest mt-1">{reward.pts}</p>
                     </div>
                  </div>
                  <div className="flex flex-col items-end gap-2">
                     <span className="text-[9px] text-red-500 font-bold uppercase tracking-widest">{reward.expiry}</span>
                     <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-brand-neon group-hover:text-brand-black transition-all">
