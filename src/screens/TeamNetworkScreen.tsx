    ...
    <div className="min-h-screen bg-brand-black flex flex-col p-6 pt-12 overflow-y-auto pb-32">
      ...
      <section className="flex flex-col gap-4">
        <div className="flex items-center justify-between px-2">
           <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/30">Total Members (142)</h3>
           ...
           {teamMembers.map((member, i) => (
             ...
             >
                <div className="flex items-center gap-4">
                   <div className="w-12 h-12 rounded-2xl overflow-hidden border border-white/10 p-1">
                      <img 
