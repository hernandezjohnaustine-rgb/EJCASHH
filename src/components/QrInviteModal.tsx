    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <GlassCard className="!p-8 overflow-hidden relative border-brand-primary/20 bg-brand-navy shadow-[0_0_50px_rgba(250,204,21,0.2)]">
              <button 
                onClick={onClose}
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="w-full space-y-4">
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <p className="text-sm font-mono font-bold text-brand-primary tracking-wider">{referralCode}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button className="flex items-center justify-center gap-2 py-3 bg-brand-primary text-brand-black rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-[0_0_15px_#FACC15] hover:brightness-110 active:scale-95 transition-all">
